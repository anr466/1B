    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          child: Column(
            children: [
              AppScreenHeader(title: 'إعدادات الإشعارات', showBack: true),
              Expanded(
                child: _loading
                        ...
                        children: [
                          ...
                          _switchCard(
                            ...
                            onChanged: _settings!.pushEnabled
                                ? (v) => _update(
                                    _settings!.copyWith(notifyNewDeal: v),
                                  )
                                : null,
                          ),
                          _switchCard(
                            ...
                            onChanged: _settings!.pushEnabled
                                ? (v) => _update(
                                    _settings!.copyWith(notifyDealProfit: v),
                                  )
                                : null,
                          ),
                          _switchCard(
                            ...
                            onChanged: _settings!.pushEnabled
                                ? (v) => _update(
                                    _settings!.copyWith(notifyDealLoss: v),
                                  )
                                : null,
                          ),
