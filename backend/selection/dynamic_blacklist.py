...
class DynamicBlacklist:
    ...
    def __init__(self, db_manager=None):
        ...
        # سجل الأداء لكل عملة
        self.performance: Dict[str, Dict] = defaultdict(lambda: {
            'total_trades': 0,
            'wins': 0,
            'losses': 0,
    ...
    def record_trade(self, symbol: str, is_win: bool, pnl: float):
        ...
        self.logger.info(f"📊 {symbol}: {'✅' if is_win else '❌'} | "
    ...
    def get_status(self) -> Dict:
        ...
        return {
            ...
            'total_trades_recorded': sum(p['total_trades'] for p in self.performance.values()),
            'config': self.config
        }
    ...
    def load_from_database(self):
        ...
        try:
            ...
            with self.db.get_connection() as conn:
                ...
                self.logger.info(f"📊 تم تحميل {len(trades)} صفقة من قاعدة البيانات")
