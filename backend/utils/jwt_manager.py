...
class JWTManager:
    ...
    def verify_token(self, token: str) -> Optional[Dict]:
        ...
        try:
            ...
            logger.debug(f"✅ تم التحقق من token للمستخدم {payload.get('user_id')}")
    ...
    def refresh_token(self, refresh_token: str, expiration_hours: int = 24) -> Optional[str]:
        """
    ...
    def get_token_info(self, token: str) -> Optional[Dict]:
        ...
        return {
            ...
            'created_at': datetime.fromtimestamp(payload.get('iat')).isoformat()
        }
...
def require_token(f):
    ...
    def decorated_function(*args, **kwargs):
        ...
        try:
            ...
            return jsonify({'success': False, 'message': 'صيغة Token غير صحيحة'}), 401
