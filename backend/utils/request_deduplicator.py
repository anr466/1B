...
class RequestDeduplicator:
    ...
    def _generate_key(self, user_id: int, endpoint: str, method: str, payload: dict) -> str:
    ...
    def is_duplicate(self, user_id: int, endpoint: str, method: str, payload: dict) -> bool:
        """
    ...
    def mark_completed(self, user_id: int, endpoint: str, method: str, payload: dict):
...
def prevent_concurrent_duplicates(f):
    ...
    def decorated_function(*args, **kwargs):
        ...
        # فحص التكرار
        if request_deduplicator.is_duplicate(user_id, endpoint, method, payload):
            return jsonify({
                'success': False,
        ...
        try:
            ...
            # وضع علامة على اكتمال الطلب
            request_deduplicator.mark_completed(user_id, endpoint, method, payload)
