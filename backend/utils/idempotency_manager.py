...
class IdempotencyManager:
    ...
    def _generate_key(self, user_id: int, operation: str, payload: dict) -> str:
    ...
    def check_and_store(self, user_id: int, operation: str, payload: dict) -> Optional[Dict[str, Any]]:
        """
    ...
    def store_response(self, user_id: int, operation: str, payload: dict, response: dict):
        ...
        def decorated_function(*args, **kwargs):
            ...
            if not user_id and not require_user_id:
                try:
                    ...
                    alt_id = payload.get('email') or payload.get('username') or payload.get('phone') or 'anonymous'
