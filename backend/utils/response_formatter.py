...
class ResponseFormatter:
    ...
    @staticmethod
    def success(
        data: Any = None, message: str = "نجح", status_code: int = 200
    ) -> tuple:
        """إنشاء Response نجح"""
        response = {
            "success": True,
    ...
    @staticmethod
    def paginated(
        items: list, total: int, page: int, limit: int, message: str = "نجح"
    ) -> tuple:
...
def error_response(
    error, error_code="UNKNOWN_ERROR", status_code=400, details=None
):
