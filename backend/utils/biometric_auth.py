...
class BiometricAuthManager:
    ...
    def __init__(
        self, hash_algorithm: str = "sha256", timeout_seconds: int = 300
    ):
        """
        تهيئة مدير البصمة
    ...
    def hash_biometric(
        self, biometric_data: str, salt: Optional[str] = None
    ) -> Tuple[str, str]:
        """
    ...
    def verify_biometric(
        self, biometric_data: str, stored_hash: str, salt: str
    ) -> bool:
        """
    ...
    def can_use_biometric_login(self, user_data: Dict) -> Tuple[bool, str]:
        """
        ...
        try:
            ...
            # جميع الشروط متحققة
            logger.info(f"✅ المستخدم {
                user_data.get('user_id')} يمكنه استخدام الدخول بالبصمة")
    ...
    def get_biometric_status(self, user_data: Dict) -> Dict:
        ...
        return {
            ...
            "save_credentials_enabled": bool(
                user_data.get("save_credentials")
            ),
...
biometric_manager = BiometricAuthManager(
    hash_algorithm="sha256", timeout_seconds=300
)


def create_biometric_manager(
    hash_algorithm: str = "sha256", timeout_seconds: int = 300
